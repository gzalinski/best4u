<?php
/**
 * best4u functions and definitions
 *
...
if ( ! function_exists( 'best4u_setup' ) ) :
	...
	function best4u_setup() {
		 ...
		 * If you're building a theme based on best4u, use a find and replace
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'best4u' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'best4u_custom_background_args', array(
 ...
 */
function best4u_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'best4u_content_width', 640 );
}
add_action( 'after_setup_theme', 'best4u_content_width', 0 );
...
function best4u_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'best4u' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'best4u' ),
...
function best4u_scripts() {
	...
	wp_enqueue_script( 'best4u-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'best4u-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
